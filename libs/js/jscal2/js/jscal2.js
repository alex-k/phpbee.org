...
var aA={x:
    ...
    l.setTime=function(au,P) {
		...
		this.selection.onChange(this.selection); 
            }
        }
    };
    l.getHours=function() {
    ...
    function H(D) {
       ...
       var r={"DynarchCalendar-topCont":"topCont"
    ...
    function K() {
var ar=G("div"),P=this.els={},D={mousedown:
                                 v(I,this,true),mouseup:
                                 v(I,this,false),mouseover:
                                 v(T,this,true),mouseout:
                                 v(T,this,false),keypress:
                                         v(L,this)};
...
var D=au.getAttribute("dyc-btn"),ax=au.getAttribute("dyc-type"),av=au.getAttribute("dyc-date"),at=this.selection,ar,P={mouseover:
                                    an,mousemove:
                                    an,mouseup:
            function(aC) {
