...
class module_velotur  implements gs_module {
    ...
    static function get_handlers() {
	    ...
	    'get_post'=>array(
                'news'=>'gs_base_handler.show',
                'news/*'=>'gs_base_handler.show:{name:news_show.html}',
                'adm_news'=>'gs_base_handler.show',
                'form/tw_news'=>'gs_base_handler.postform:{name:form.html:form_class:g_forms_table:classname:tw_news:href:adm_news}',
                'form/tw_news/delete'=>'gs_base_handler.deleteform:{name:form_href.html:classname:tw_news:fields:id}',
		'images'=>'handler_velotur.many2one:{name:images.html}',
		'images/show'=>'handler_velotur.show_images',
		'img/show'=>'handler_velotur.show_images',
		'many2one'=>'handler_velotur.many2one:{name:many2one.html}',
...
class handler_velotur extends gs_base_handler {
	function many2one() {
